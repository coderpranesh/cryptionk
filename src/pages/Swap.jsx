        ...
        <div className="main-container">
          <div className="cryptionk">
            ...
            <div className="contact text-white">
              <h1 className="text-center" style={{ fontSize: 55, fontWeight: '400 !important', textShadow: '0px 5px 3px #441d20' }}>
                Newsletter</h1>
              <h5 className="text-center" style={{ fontWeight: '400 !important', color: '#b8a8a9 !important' }}>Bringing you the
                best ideas,
              ...
              <div className="row m-0 pt-4 px-4">
                ...
                <div className="col-12 col-xl-4 mx-4 m0 col-card1">
                  <div className="row m-0 pt-5 text-white">
                    <div className="col"><h1 style={{ fontWeight: 600 }}>Lite</h1></div>
                    <div className="col d-flex align-items-end" style={{ justifyContent: 'end' }}><h4 style={{ fontWeight: 300, paddingBottom: 2 }}>Free</h4></div>
                  </div>
                  <div className="row m-0 mt-5 text-white card1" style={{ border: '1px solid #ffffff4d', borderRadius: 50 }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal1"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>Crypto 10x to 100x</h5>
                  ...
                  <div className="row m-0 mt-5 text-white card1" style={{ border: '1px solid #ffffff4d', borderRadius: 50 }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal2"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>Biostocks</h5>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45px">
                        <rect className="rect" x={8} y={6} width={8} height={12} fill="#ffffff" />
                        <path className="path" fill="#602b77" d="M12 2C17.5 2 22 6.5 22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M8 17H16V15H8V17M16 10H13.5V6H10.5V10H8L12 14L16 10Z" />
                      </svg>
                  ...
                  <div className="row m-0 mt-5 text-white card1" style={{ border: '1px solid #ffffff4d', borderRadius: 50 }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal3"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>Hyperstocks</h5>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45px">
                        <rect className="rect" x={8} y={6} width={8} height={12} fill="#ffffff" />
                        <path className="path" fill="#602b77" d="M12 2C17.5 2 22 6.5 22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M8 17H16V15H8V17M16 10H13.5V6H10.5V10H8L12 14L16 10Z" />
                      </svg>
                  ...
                  <div className="row m-0 mt-5 text-white card1" style={{ border: '1px solid #ffffff4d', borderRadius: 50 }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal6"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>The Gem Crypto</h5>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45px">
                        <rect className="rect" x={8} y={6} width={8} height={12} fill="#ffffff" />
                        <path className="path" fill="#602b77" d="M12 2C17.5 2 22 6.5 22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M8 17H16V15H8V17M16 10H13.5V6H10.5V10H8L12 14L16 10Z" />
                      </svg>
                ...
                <div className="col-12 col-xl-4 mx-4 m0 col-card2">
                  <div className="row m-0 pt-5 text-white">
                    <div className="col"><h1 style={{ fontWeight: 600 }}>Premium</h1></div>
                    <div className="col d-flex align-items-end" style={{ justifyContent: 'end' }}><h4 style={{ fontWeight: 300, paddingBottom: 2 }}>Paid</h4></div>
                  </div>
                  <div className="row m-0 mt-5 text-white card2" style={{ border: '1px solid #2BB7D5', borderRadius: 50, backgroundColor: '#2BB7D5' }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal4"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>Transforming Defence With AI</h5>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45px">
                  ...
                  <div className="row m-0 mt-5 text-white card2" style={{ border: '1px solid #2BB7D5', borderRadius: 50, backgroundColor: '#2BB7D5' }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal5"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>Tokenization</h5>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45px">
                        <rect x={8} y={6} width={8} height={12} fill="#602b77" />
                        <path fill="#fff" d="M12 2C17.5 2 22 6.5 22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M8 17H16V15H8V17M16 10H13.5V6H10.5V10H8L12 14L16 10Z" />
                      </svg>
                  ...
                  <div className="row m-0 mt-5 text-white card2" style={{ border: '1px solid #2BB7D5', borderRadius: 50, backgroundColor: '#2BB7D5' }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal7"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>NEW GLOBAL D-ECONOMY</h5>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45px">
                        <rect x={8} y={6} width={8} height={12} fill="#602b77" />
                        <path fill="#fff" d="M12 2C17.5 2 22 6.5 22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M8 17H16V15H8V17M16 10H13.5V6H10.5V10H8L12 14L16 10Z" />
                      </svg>
                  ...
                  <div className="row m-0 mt-5 text-white card2" style={{ border: '1px solid #2BB7D5', borderRadius: 50, backgroundColor: '#2BB7D5' }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal8"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>Future Of Crypto Energy</h5>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45px">
                        <rect x={8} y={6} width={8} height={12} fill="#602b77" />
                        <path fill="#fff" d="M12 2C17.5 2 22 6.5 22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M8 17H16V15H8V17M16 10H13.5V6H10.5V10H8L12 14L16 10Z" />
                      </svg>
                  ...
                  <div className="row m-0 mt-5 text-white card2" style={{ border: '1px solid #2BB7D5', borderRadius: 50, backgroundColor: '#2BB7D5' }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal9"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>Dawn Of New Era 2024-2030</h5>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45px">
                        <rect x={8} y={6} width={8} height={12} fill="#602b77" />
                        <path fill="#fff" d="M12 2C17.5 2 22 6.5 22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M8 17H16V15H8V17M16 10H13.5V6H10.5V10H8L12 14L16 10Z" />
                      </svg>
                  ...
                  <div className="row m-0 mt-5 text-white card2" style={{ border: '1px solid #2BB7D5', borderRadius: 50, backgroundColor: '#2BB7D5' }}>
                    <div className="col py-3 pl-4 pr-3 d-flex justify-content-between align-items-center btn text-white" data-toggle="modal" data-target="#Modal10"><h5 className="m-0 pr-3" style={{ textTransform: 'uppercase' }}>Wealth Of The Coming Decade</h5>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="45px">
                        <rect x={8} y={6} width={8} height={12} fill="#602b77" />
                        <path fill="#fff" d="M12 2C17.5 2 22 6.5 22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2M8 17H16V15H8V17M16 10H13.5V6H10.5V10H8L12 14L16 10Z" />
                      </svg>

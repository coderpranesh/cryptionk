  ...
  return (
    <>
      ...
      <div >
        ...
        <a href="/swipe/" className="btn button floating-button"
          style={{
            position: "fixed",
            top: "20px",
            right: "25vw",
        ...
        >
          <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 118.1" style={{ width: 20, fill: 'white', paddingRight:"2px"}}>
            <title>Swipe</title>
